...
project = 'pfxbrick'
copyright = 'Fx Bricks Inc., All Rights Reserved'
...
html_title = "PFx Brick Python API Documentation"
...
# of the sidebar.
html_logo = "_static/LogoColour120px.png"
...
latex_documents = [
  ('index', 'PFxBrick.tex', 'PFx Brick Python API Documentation',
   'Fx Bricks', 'manual'),
]
...
man_pages = [
    ('index', 'pfxbrick', 'PFx Brick Python API Documentation',
     ['Fx Bricks'], 1)
]
...
texinfo_documents = [
  ('index', 'PFxBrick', 'PFx Brick Python API Documentation',
   'Fx Bricks', 'PFxBrick', 'PFx Brick python access API',
   'Miscellaneous'),
]
