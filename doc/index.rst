...
Details on the PFx Brick and its communication protocol can be found in the `PFx Brick Interface Control Document (ICD) v3.39 <https://www.fxbricks.com//downloads/PFxBrickICD-Rev3.39.pdf>`_.  This comprehensive document fundamentally describes the operation of the PFx Brick and is used to develop both the firmware and host software APIs designed to communicate with the PFx Brick.
...
* `Fx Bricks Resources page <https://www.fxbricks.com/resources>`_

* `Fx Bricks website <https://www.fxbricks.com>`_
